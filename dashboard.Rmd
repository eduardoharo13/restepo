...
#Módulo 200
cap200<-read.spss("D:/BD_varias/RENADEF 2017/200.sav",to.data.frame=T)
...
leaflet(peru_prov) %>%
  ...
  addPolygons(weight = 1,
              ...
              popup = ~paste("<b>Provincia:</b>", NAME_2,
                             ...
                             "<br/>",
                             "<b>Denuncias contra la persona:</b>",cap100$FALTAS_A,
                             "<br/>",
                             "<b>Denuncias contra el patrimonio:</b>",cap100$FALTAS_B,
                             "<br/>",
                             "<b>Denuncias contra las buenas costumbres:</b>",cap100$FALTAS_C,
                             "<br/>",
                             "<b>Denuncias contra la seguridad pública:</b>",cap100$FALTAS_D
              ),
...
renderValueBox({         
  ...
  filter(NOMBREDD == input$Departamento,              
      ...
      valueBox(as.numeric(sum(table(filtered$IH208_GENERICO))), "Delitos totales por departamento", icon = "fa-balance-scale", color = "navy")   
    })
...
renderValueBox({         
  ...
  filter(NOMBREDD == input$Departamento,              
      ...
      valueBox(as.numeric(sum(table(filtered$IH208_GENERICO))), "Delitos totales por provincia", icon = "fa-balance-scale", color = "blue")   
    })
...
renderValueBox({         
  ...
  filter(NOMBREDD == input$Departamento,              
      ...
      valueBox(as.numeric(sum(table(filtered$IH208_GENERICO))), "Delitos totales por distrito", icon ="fa-balance-scale", color = "purple")   
    })
...
-----------------------------------------------------------------------
### Evolución de tipos de delitos reportados por distrito
```{r}
...
### Tipos de delitos reportados por distrito
