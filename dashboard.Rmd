...
```{r}
# c <- reactive({as.numeric(sum(table(cap200$IH208_GENERICO)))})
# renderValueBox(c(), caption = "Denuncias totales")
valueBox(nrow(cap200), caption = "Denuncias totales",icon="fa-tag",col="primary")
```
...
# c <- reactive({as.numeric(sum(table(cap200$IH208_GENERICO)))})
# renderValueBox(c(), caption = "Denuncias totales")
valueBox(nrow(cap100), caption = "Faltas totales",icon="fa-tag",col="success")
```
